...
function loadMap() {
  mapboxgl.accessToken =
    "pk.eyJ1Ijoic3RyYW56ZXJuZWVyYXoiLCJhIjoiY2xqcjJhdjhsMDNrYjNjdnN4a3IyM3l1biJ9.DVRVAz534tJ0fGyhteiEEQ";
  ...
  var popup = new mapboxgl.Popup({ closeButton: false }).setHTML(
    "<h3>Food Delivery App Office</h3><p>B71 2RJ, West Bromwich, United Kingdom</p>"
  );
  ...
  markerStyle.textContent =
    ".marker { background-color: #f15a24; width: 24px; height: 24px; border-radius: 50%; cursor: pointer; }";
